...
| --- | --- | --- |
| `anton415/anton415-os` | Active flagship engineering repository for future product work. | Source of truth. |
...
Active implementation now happens only in `anton415-os`.
...
- Documentation that conflicts with `anton415-os` as the source of truth.
...
4. Reimplement or document it in `anton415-os` using the current project boundaries.
...
> This repository is retained as a legacy reference. Active development has moved to `anton415/anton415-os`, which is now the source of truth for roadmap, architecture, and implementation.

Suggested notice for `anton415/anton415.github.io` if needed:

> This repository is the public portfolio and writing surface for `anton415`. Engineering source-of-truth documentation and implementation for the flagship project live in `anton415/anton415-os`.
