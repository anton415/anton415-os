...
The default backup policy is budget-first: Terraform keeps independent daily dumps for 7 days and monthly dumps for 90 days. The script writes archive names with a timestamp plus a unique temporary-directory suffix, so Object Storage versioning is intentionally not enabled.
